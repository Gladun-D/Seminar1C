...
// Метод формирования нового масива на основе исходного( который содержит противоположныые элементы)
// Тут метод просто принимает и возвращает массив
...
// А тут метод сразу берёт исходный массив и сразу его меняет.
...
//Метод поиска эллемента (получаем колличество эллементов и пробегаем по всем - ищем нужный)
...
// Такой же метод,только автоматический
